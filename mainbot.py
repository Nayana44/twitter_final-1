...
while True:
    user = api.get_user('Nayana11774541')
    api.update_profile(name=f'Nayana|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Nayana|{follower_count(user)} Followers')
